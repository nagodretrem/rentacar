...
public class TransmissionsController {
    ...
    public CreatedTransmissionResponse add(@RequestBody @Valid CreateTranmissionRequest createTransmissionRequest){
        return transmissionService.add(createTransmissionRequest);
    }


    @PutMapping
    public UpdatedTransmissionResponse update(@RequestBody @Valid UpdateTransmissionRequest updateTransmissionRequest){
